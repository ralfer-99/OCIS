    ...
    <div class="maincontent">
        ...
        <?php
            ...
            if (isset($_POST['approve'])) {
                ...
                header("location:newdetails.php");
            }
        ...
        <div class="mainbox">
            ...
            <table>
                ...
                <tr>
                    <td>Image</td>
                    <td><img src="<?php echo $imagePath; ?>" alt="Uploaded Image"></td>
                </tr>
            </table>

            <button  onclick="req('<?php echo $updateRegRow['regNo'];?>','approve')">Approve</button>
